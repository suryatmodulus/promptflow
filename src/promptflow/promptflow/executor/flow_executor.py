...
class FlowExecutor:
    ...
    def _apply_inputs_mapping_for_all_lines(
        ...
        if len(merged_list) == 0:
            raise InputMappingError(
                message_format=(
                    "The input for flow is incorrect. To execute properly, data must be provided on the same line. "
                    "However, a complete line of data could not be found based on the provided input. "
